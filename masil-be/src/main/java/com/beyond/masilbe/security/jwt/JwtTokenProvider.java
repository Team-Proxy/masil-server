...
public class JwtTokenProvider {
    ...
    public String generateAccessToken(final Long userId, final String email) {
        return generateAccessTokenInternal(userId, email, accessTokenExpiration, JwtTokenType.ACCESS.name());
    }

    /** Refresh Token 생성 */
    public String generateRefreshToken(final Long userId) {
        return generateRefreshTokenInternal(userId, refreshTokenExpiration);
    }

    /** 공통 토큰 생성 로직 */
    private String generateAccessTokenInternal(
            final Long userId, final String email, final long expirationMillis, final String tokenType) {
    ...
    // 내부용 Refresh 생성
    private String generateRefreshTokenInternal(final Long userId, final long expirationMillis) {
        final Date now = new Date();
        final Date expiry = new Date(now.getTime() + expirationMillis);
